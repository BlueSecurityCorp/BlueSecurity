...
const ui = {
  ko: {
    ...
    'about.tech.subtitle': '검증된 자동화 기술로 중소기업에 최적화된 코드 보안 점검 환경을 제공합니다.',
  ...
  en: {
    ...
    'about.tech.subtitle': 'Providing code security checks optimized for SMEs with proven automation technology.',
