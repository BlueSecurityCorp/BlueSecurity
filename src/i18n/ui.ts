...
const ui = {
  ko: {
    ...
    'news.published.heading': '발행된 뉴스',
    'news.published.subtitle': '검수와 발행 승인이 완료된 최신 콘텐츠입니다.',
  ...
  en: {
    ...
    'news.published.heading': 'Published news',
    'news.published.subtitle': 'The latest reviewed and approved content.',
