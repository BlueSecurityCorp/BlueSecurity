...
const ui = {
  ko: {
    ...
    'cta.description': 'CodeBlue로 코드 보안 점검을 시작하고, 개발 단계의 보안 이슈를 빠르게 확인하세요.',
    'cta.trust': '2026년 12월 31일까지 CodeBlue 무료 제공',
    'cta.button.start': 'CodeBlue 무료 체험',
    'cta.button.contact': '문의하기',
    ...
    'pricing.custom.description': '대규모 도입이나 별도 운영 환경이 필요한 경우 요구사항에 맞춰 안내해 드립니다.',
  ...
  en: {
    ...
    'cta.description': 'Start code security checks with CodeBlue and quickly identify security issues during development.',
    ...
    'pricing.custom.description': 'For large-scale adoption or separate operating environments, we will guide you based on your requirements.',
