...
const ui = {
  ko: {
    ...
    'about.tech.subtitle': '보안 데이터를 분석하고 반복 업무를 자동화해 중요한 위험을 빠르게 식별하고 대응할 수 있도록 지원합니다.',
    'about.cta': '합리적 보안, 지금 시작하세요',
    'about.cta.description': '제품 데모 또는 도입 문의가 필요하시면 언제든지 연락해 주세요.',
    ...
    // News page
    'news.title': '뉴스 | BlueSecurity',
    'news.meta': '꼭 알아야 할 보안 이슈와 산업 동향, BlueSecurity의 인사이트를 전합니다.',
    'news.eyebrow': 'Security Briefing',
    'news.heading': '보안을 읽는 새로운 기준',
    'news.subtitle': '복잡한 보안 이슈를 실무에 필요한 핵심만 골라 전합니다.',
    'news.search': '뉴스 검색',
    'news.search.placeholder': '제목, 요약 또는 태그 검색',
    'news.filter.all': '전체',
    'news.filter.category': '카테고리',
    'news.filter.date': '발행일 범위',
    'news.filter.dateFrom': '시작일',
    'news.filter.dateTo': '종료일',
    'news.filter.reset': '초기화',
    'news.filter.template': '콘텐츠 유형',
    'news.count': '개의 콘텐츠',
    'news.empty': '아직 등록된 뉴스가 없습니다.',
    'news.noResults': '검색 조건에 맞는 콘텐츠가 없습니다.',
    'news.featured': '주요 콘텐츠',
    'news.read': '읽어보기',
    'news.back': '뉴스 목록',
    'news.publishedAt': '발행일',
    'news.updatedAt': '최종 수정',
    'news.source': '원문 출처',
    'news.share': '공유하기',
    'news.copied': '링크를 복사했습니다',
    'news.related': '함께 읽으면 좋은 콘텐츠',
    'news.published.heading': '블루 보안뉴스',
    'news.published.subtitle': '뉴스래터, 카카오톡 채널 등으로 발송된 콘텐츠를 이곳에서 확인하세요.',
    'news.pagination.label': '뉴스 페이지 이동',
    'news.pagination.page': '페이지',
    'news.pagination.prev': '이전',
    'news.pagination.next': '다음',
    ...
    'products.page.meta': 'BlueSecurity의 사이버보안 제품',
    'products.page.eyebrow': '제품 포트폴리오',
    'products.page.heading': '제품 소개',
    'products.page.subtitle': '소스코드 보안 점검을 합리적 비용으로 시작할 수 있습니다.',
    'products.page.bundle.heading': 'CodeBlue로 개발 단계 보안을 시작하세요',
    'products.page.bundle.description': '소스코드와 오픈소스 구성 요소의 위험을 확인하고, 개발 흐름 안에서 보안 점검을 반복하세요.',
    ...
    'footer.contact.prompt': '제품 도입 문의',
    ...
    'careers.subtitle': 'BlueSecurity는 작은 팀도 보안을 쉽게 시작할 수 있는 제품을 함께 만들어갈 동료를 찾고 있습니다.',
  ...
  en: {
    ...
    'about.tech.subtitle': 'We analyze security data and automate repetitive work so organizations can identify and address critical risks faster.',
    'about.cta': 'Start Affordable Security Today',
    'about.cta.description': 'Contact us anytime for product demos or deployment support.',
    ...
    // News page
    'news.title': 'News | BlueSecurity',
    'news.meta': 'Security issues, industry news, and practical insights curated by BlueSecurity.',
    'news.eyebrow': 'Security Briefing',
    'news.heading': 'A clearer read on security',
    'news.subtitle': 'Practical context on the security issues that matter to your team.',
    'news.search': 'Search news',
    'news.search.placeholder': 'Search titles, summaries, or tags',
    'news.filter.all': 'All',
    'news.filter.category': 'Category',
    'news.filter.date': 'Publication date range',
    'news.filter.dateFrom': 'From',
    'news.filter.dateTo': 'To',
    'news.filter.reset': 'Reset',
    'news.filter.template': 'Content type',
    'news.count': 'articles',
    'news.empty': 'No news has been published yet.',
    'news.noResults': 'No content matches your search.',
    'news.featured': 'Featured',
    'news.read': 'Read article',
    'news.back': 'Back to News',
    'news.publishedAt': 'Published',
    'news.updatedAt': 'Updated',
    'news.source': 'Original source',
    'news.share': 'Share',
    'news.copied': 'Link copied',
    'news.related': 'Related reading',
    'news.published.heading': 'Blue Security News',
    'news.published.subtitle': 'Check here for content sent via newsletters, KakaoTalk channels, etc.',
    'news.pagination.label': 'News pagination',
    ...
    'products.page.meta': 'BlueSecurity cybersecurity product',
    'products.page.eyebrow': 'Product Portfolio',
    'products.page.heading': 'Our Products',
    'products.page.subtitle': 'Start source code security checks for SMEs at reasonable costs.',
    'products.page.bundle.heading': 'Start Development-Stage Security With CodeBlue',
    'products.page.bundle.description': 'Use CodeBlue to find source code and open-source component risks, and repeat security checks inside your development workflow.',
    ...
    'footer.contact.prompt': 'Product Deployment Inquiry',
    ...
    'careers.subtitle': 'BlueSecurity is looking for teammates to build security products that small teams can start using with less friction.',
