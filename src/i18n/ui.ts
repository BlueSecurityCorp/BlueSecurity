...
const ui = {
  ko: {
    ...
    'news.heading': '뉴스',
    'news.subtitle': '뉴스래터, 카카오톡 채널 등으로 발송된 블루 보안뉴스 콘텐츠를 이곳에서 확인하세요.',
    'news.search': '뉴스 검색',
  ...
  en: {
    ...
    'news.eyebrow': 'Security Briefing',
    'news.heading': 'News',
    'news.subtitle': 'View Blue Security News content delivered through newsletters, KakaoTalk channels, and more.',
